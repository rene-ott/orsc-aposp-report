...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20211115182834_InitialCreate') THEN
...
BEGIN
    ...
    VALUES ('20211115182834_InitialCreate', '5.0.10');
    END IF;
END $EF$;
COMMIT;
